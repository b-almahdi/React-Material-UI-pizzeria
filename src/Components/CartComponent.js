...
class CartComponent extends Component {
    ...
    render() {
        const { classes, cart, totalPrice, checkout, updateQuantity, removeCartItem,PostOrder} = this.props;
        const cartExists =  cart.length > 0;
        console.log("%c" + cartExists, "background: #222; color: #bada55");
        if(cartExists){
        return (
                ...
                >
                    ...
                    <Grid container justify = "center">
                        ...
                        <Tooltip title="Total Cost" placement="top">
                            <Chip color="primary" className={classes.chip}  label={  `${parseFloat(Math.round(totalPrice * 100) / 100).toFixed(2)} Dhs`}/>
                        </Tooltip>
                    </Grid>
                    ...
                    <div style={getModalStyle()} className={classes.paper}>
                        <Grid container justify = "center">
                            <Typography variant="title" className={classes.totalTitle}>
                                Total is: {parseFloat(Math.round(totalPrice * 100) / 100).toFixed(2)} Dhs
                            </Typography>
