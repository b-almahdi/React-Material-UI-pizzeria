...
class Users extends React.Component {
    ...
    return (
      <div className="container" >
        <div className="row mb-4">
          <div className="col-2" >
            <input id="nom" onChange={(event) => this.inputChanged(event, 'nom')} />
          </div>
          <div className="col-2" >
            <input id="prenom" onChange={(event) => this.inputChanged(event, 'prenom')} />
          </div>
          <div className="col-2" >
            <input id="adresse" onChange={(event) => this.inputChanged(event, 'adresse')} />
          </div>
          <div className="col-2" >
            <input id="telephone" onChange={(event) => this.inputChanged(event, 'telephone')} />
          </div>
          <div className="col-2" >
  ...
  addUser = () => {
    this.props.addUser({ nom: this.state.nom,
